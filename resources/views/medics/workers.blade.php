            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="tab-veracruz" data-toggle="pill" href="#cont-veracruz" role="tab"
                                aria-controls="cont-veracruz" aria-selected="true">Veracruz</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-xalapa" data-toggle="pill" href="#cont-xalapa" role="tab"
                                aria-controls="cont-xalapa" aria-selected="false">Xalapa</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-cordoba" data-toggle="pill" href="#cont-cordoba" role="tab"
                                aria-controls="cont-cordoba" aria-selected="false">Cordoba</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="cont-veracruz" role="tabpanel"
                            aria-labelledby="tab-veracruz">
