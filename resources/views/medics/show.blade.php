    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
              ...
              <a href="/workers/edit/{{$trabajador->id}}" type="button" class="float-right btn btn-primary">Editar</a>
            </div>
            <div class="card-body">                
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">                    
                            ...
                            <div class="col-md-6">
                                <span>@if(isset($trabajador->getInst->instis)){{$trabajador->getInst->instis}}@endif</span><br>
                                <span>@if(isset($trabajador->getMedic->medico)){{$trabajador->getMedic->medico}}@endif</span>
                            </div>
                        </div>
                    </div>
                </div>
